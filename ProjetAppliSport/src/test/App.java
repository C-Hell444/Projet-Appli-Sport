...
public class App {
	...
	public static void menuAdmin() {
		...
		//## SELECT * (validation admin attribut table OU nouvelle table_tampon OU accès java)
	...
	public static void menuClub() {
			...
			//	modifs profil
			// 	créer equipes + FILTRES par sélection par critères joueurs
			// 	créer evenements avec des paramètres
			//	demande d'inscription à l'admin (evenements, sports)
			//	rechercher avec des FILTRES ! (partenaires/localisation/sports...)
