...
public class EvenementService {
	...
	public Evenement getByIdWithEvenementUtilisateurOrderByDateDebutAsc(Long id) {
		return evenementRepository.findByIdWithEvenementUtilisateurOrderByDateDebutAsc(id)
				.orElseThrow(EvenementException::new);
	}

	public Evenement getByIdWithEvenementUtilisateurOrderByDateDebutDesc(Long id) {
		return evenementRepository.findByIdWithEvenementUtilisateurOrderByDateDebutDesc(id)
				.orElseThrow(EvenementException::new);
	}

	public Evenement getByIdWithEvenementUtilisateurOrderByDateFinAsc(Long id) {
		return evenementRepository.findByIdWithEvenementUtilisateurOrderByDateFinAsc(id)
				.orElseThrow(EvenementException::new);
	}

	public Evenement getByIdWithEvenementUtilisateurOrderByDateFinDesc(Long id) {
		return evenementRepository.findByIdWithEvenementUtilisateurOrderByDateFinDesc(id)
				.orElseThrow(EvenementException::new);
	}
